...
class Telegram {
    ...
    _runMenu(menuData) {
        ...
        var ignoredKeys = [
            'message', 'layout', 'options', 'anyMatch',
            'resize_keyboard', 'hide_keyboard', 'one_time_keyboard'
        ]
        ...
        var options = {
            reply_markup: JSON.stringify({
                hide_keyboard: ( menuData.hide_keyboard == undefined || menuData.hide_keyboard ),
                resize_keyboard: ( menuData.resize_keyboard && menuData.resize_keyboard == true ),
                one_time_keyboard: ( menuData.one_time_keyboard == undefined || menuData.one_time_keyboard ),
                keyboard: keyboard
            })
        }
