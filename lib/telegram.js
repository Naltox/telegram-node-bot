...
class Telegram {
    ...
    _createScope(chatId, user, update) {
        ...
        var funcs = [
            ...
            'sendContact', 'sendVenue', 'unbanChatMember', 'kickChatMember', 'runInlineMenu', 'runForm'
        ]
    ...
    runForm(chatId, formData, callback) {
        var i = 0
        var self = this;
        ...
        var run = () => {
            ...
            self.sendMessage(chatId, formData[key].q, {
            ...
            self.waitForRequest(chatId, ($) => {
                formData[key].validator($.message, (valid) => {
                    if (valid == true) {
                        ...
                        self.sendMessage(chatId, formData[key].error, {
                            disable_web_page_preview: true
                        }, () => {
                            run()
                        })
