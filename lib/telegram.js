...
class Telegram {
    ...
    _processCommand(update) {
        ...
        if (update.chosen_inline_result) {
            var inlineQuery = update.chosen_inline_result
    ...
    _runMenu(menuData) {
        ...
        var ignoredKeys = ['message', 'layout', 'options', 'resize_keyboard', 'one_time_keyboard']
        ...
        var options = {
            reply_markup: JSON.stringify({
                ...
                one_time_keyboard: ( menuData.one_time_keyboard && menuData.one_time_keyboard == true ),
                keyboard: keyboard
            })
        }
